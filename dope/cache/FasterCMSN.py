...
class CacheModel(object):
    ...
    def _rebalance_request(self, rebalance_entry):
        ...
        '''
        root_entry = copy.deepcopy(rebalance_entry)
    ...
    def _filter_cache_occupancy(self, entry):
        ...
        cache
        '''
        return not (enc2string(entry.encoding) in self.cache_lookup)
